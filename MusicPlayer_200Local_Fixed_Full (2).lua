    ...
    pcall(function()
        if writefile then
            writefile(SETTINGS_FILE, HttpService:JSONEncode({
                ...
                S.saveThemeEnabled=S.saveThemeEnabled,
                S.rememberKeyEnabled=S.rememberKeyEnabled,
                S.timeSliderBlue=S.timeSliderBlue,
                S.keybindEnabled=S.keybindEnabled,
                S.autoTranslateEnabled=S.autoTranslateEnabled
            }))
        end
    end)
end
...
local function createHideShowButtons()
    ...
    local showScreenGui=Instance.new("S.ScreenGui"); showScreenGui.Name="MusicPlayerShowGui"; showScreenGui.ResetOnSpawn=false; showScreenGui.ZIndexBehavior=Enum.ZIndexBehavior.Sibling; showScreenGui.Parent=CoreGui
    ...
    Instance.new("S.UIStroke",S.showButton).Thickness=2
    S.showButton.S.UIStroke.Color=Color3.fromRGB(255,255,255); S.showButton.S.UIStroke.Transparency=0.5
...
local function createExtraMiniGUI()
    ...
    S.ExtraMiniScreenGui=Instance.new("S.ScreenGui"); S.ExtraMiniScreenGui.Name="MusicPlayerExtraMini"; S.ExtraMiniScreenGui.ResetOnSpawn=false; S.ExtraMiniScreenGui.ZIndexBehavior=Enum.ZIndexBehavior.Sibling; S.ExtraMiniScreenGui.Parent=CoreGui; S.ExtraMiniScreenGui.Enabled=false
...
local function createMainGUI()
    ...
    S.ScreenGui=Instance.new("S.ScreenGui"); S.ScreenGui.Name="MusicPlayerGUI"; S.ScreenGui.ResetOnSpawn=false; S.ScreenGui.ZIndexBehavior=Enum.ZIndexBehavior.Sibling; S.ScreenGui.Parent=CoreGui; S.ScreenGui.Enabled=true
    ...
    S.UIStroke=Instance.new("S.UIStroke"); S.UIStroke.Thickness=3; S.UIStroke.Color=Color3.fromRGB(80,80,80); S.UIStroke.Parent=S.OutlineFrame
...
<font color="#3498db">https://discord.gg/hTEvZ3nkZd</font>]]
    ...
    S.SearchPanelStroke=Instance.new("S.UIStroke",S.SearchPanel); S.SearchPanelStroke.Thickness=3.5; S.SearchPanelStroke.Color=Color3.fromRGB(150,150,160); S.SearchPanelStroke.Transparency=0.5
    ...
    -- Mini GUI
    S.MiniScreenGui=Instance.new("S.ScreenGui"); S.MiniScreenGui.Name="MusicPlayerMiniGUI"; S.MiniScreenGui.ResetOnSpawn=false; S.MiniScreenGui.ZIndexBehavior=Enum.ZIndexBehavior.Sibling; S.MiniScreenGui.Parent=CoreGui; S.MiniScreenGui.Enabled=false
    ...
    S.MiniUIStroke=Instance.new("S.UIStroke"); S.MiniUIStroke.Thickness=3; S.MiniUIStroke.Color=Color3.fromRGB(80,80,80); S.MiniUIStroke.Parent=S.MiniOutlineFrame
