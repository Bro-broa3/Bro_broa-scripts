...
function updatePlaylistDisplay()
    ...
    addBtn.Text="➕ Add your music to playlist"
...
local function createMainGUI()
    ...
    infoTabs.CanvasSize=UDim2.new(0,390,0,0)
    ...
    S.InfoHowTab.Size=UDim2.new(0,130,0,29)
    ...
    S.InfoDataTab.Size=UDim2.new(0,130,0,29)
    S.InfoDataTab.Position=UDim2.new(0,130,0,1)
    ...
    S.InfoUpdTab.Size=UDim2.new(0,130,0,29)
    S.InfoUpdTab.Position=UDim2.new(0,260,0,1)
...
• The secret key is no longer hardcoded; it is fetched from the GitHub Key file.]],
    ...
    tbf.CanvasSize=UDim2.new(0,450,0,0)
    ...
    S.SearchTabBtn=Instance.new("TextButton"); S.SearchTabBtn.Size=UDim2.new(0,150,0,29); S.SearchTabBtn.Position=UDim2.new(0,0,0,1); S.SearchTabBtn.Active=true; S.SearchTabBtn.ZIndex=12; S.SearchTabBtn.BackgroundColor3=Color3.fromRGB(100,150,255); S.SearchTabBtn.BorderSizePixel=0; S.SearchTabBtn.Text="🔍 Search"; S.SearchTabBtn.TextColor3=Color3.fromRGB(255,255,255); S.SearchTabBtn.Font=Enum.Font.GothamBold; S.SearchTabBtn.TextSize=12; S.SearchTabBtn.Parent=tbf; Instance.new("UICorner",S.SearchTabBtn).CornerRadius=UDim.new(0,6)
    S.PlaylistTabBtn=Instance.new("TextButton"); S.PlaylistTabBtn.Size=UDim2.new(0,150,0,29); S.PlaylistTabBtn.Position=UDim2.new(0,150,0,1); S.PlaylistTabBtn.Active=true; S.PlaylistTabBtn.ZIndex=12; S.PlaylistTabBtn.BackgroundColor3=Color3.fromRGB(60,60,70); S.PlaylistTabBtn.BorderSizePixel=0; S.PlaylistTabBtn.Text="📋 Playlist"; S.PlaylistTabBtn.TextColor3=Color3.fromRGB(255,255,255); S.PlaylistTabBtn.Font=Enum.Font.GothamBold; S.PlaylistTabBtn.TextSize=12; S.PlaylistTabBtn.Parent=tbf; Instance.new("UICorner",S.PlaylistTabBtn).CornerRadius=UDim.new(0,6)

    S.PlaylistSettingsTabBtn=Instance.new("TextButton"); S.PlaylistSettingsTabBtn.Size=UDim2.new(0,150,0,29); S.PlaylistSettingsTabBtn.Position=UDim2.new(0,300,0,1); S.PlaylistSettingsTabBtn.Active=true; S.PlaylistSettingsTabBtn.ZIndex=12; S.PlaylistSettingsTabBtn.BackgroundColor3=Color3.fromRGB(60,60,70); S.PlaylistSettingsTabBtn.BorderSizePixel=0; S.PlaylistSettingsTabBtn.Text="⚙ Playlist Settings"; S.PlaylistSettingsTabBtn.TextColor3=Color3.fromRGB(255,255,255); S.PlaylistSettingsTabBtn.Font=Enum.Font.GothamBold; S.PlaylistSettingsTabBtn.TextSize=10; S.PlaylistSettingsTabBtn.Parent=tbf; Instance.new("UICorner",S.PlaylistSettingsTabBtn).CornerRadius=UDim.new(0,6)
    ...
    psf.CanvasSize=UDim2.new(0,0,0,430)
    psf.Visible=false
    ...
    dragLabel.Position=UDim2.new(0,12,0,12)
    ...
    S.AllowPlaylistTabDraggingToggle.Position=UDim2.new(1,-74,0,15)
    ...
    createLabel.Position=UDim2.new(0,12,0,62)
    ...
    S.CreatePlaylistButton.Position=UDim2.new(0,12,0,87)
    ...
    S.CreatePlaylistNameBox=Instance.new("TextBox")
    S.CreatePlaylistNameBox.Size=UDim2.new(1,-24,0,34)
    S.CreatePlaylistNameBox.Position=UDim2.new(0,12,0,129)
    S.CreatePlaylistNameBox.BackgroundColor3=Color3.fromRGB(60,60,70)
    S.CreatePlaylistNameBox.BorderSizePixel=0
    S.CreatePlaylistNameBox.Text=""
    S.CreatePlaylistNameBox.PlaceholderText="Enter playlist name..."
    S.CreatePlaylistNameBox.PlaceholderColor3=Color3.fromRGB(150,150,160)
    S.CreatePlaylistNameBox.TextColor3=Color3.fromRGB(255,255,255)
    S.CreatePlaylistNameBox.Font=Enum.Font.Gotham
    S.CreatePlaylistNameBox.TextSize=11
    S.CreatePlaylistNameBox.Visible=false
    S.CreatePlaylistNameBox.ClearTextOnFocus=false
    S.CreatePlaylistNameBox.Parent=psf
    Instance.new("UICorner",S.CreatePlaylistNameBox).CornerRadius=UDim.new(0,6)

    S.CreatePlaylistConfirm=Instance.new("TextButton")
    S.CreatePlaylistConfirm.Size=UDim2.new(0,80,0,30)
    S.CreatePlaylistConfirm.Position=UDim2.new(1,-92,0,171)
    ...
    dropLabel.Position=UDim2.new(0,12,0,220)
    ...
    S.PlaylistDropdownButton.Position=UDim2.new(0,12,0,245)
    ...
    S.PlaylistDropdownList.Position=UDim2.new(0,12,0,283)
    ...
    savedHint.Position=UDim2.new(0,12,0,345)
    ...
    S.CreatePlaylistButton.MouseButton1Click:Connect(function()
        S.CreatePlaylistNameBox.Visible=not S.CreatePlaylistNameBox.Visible
        S.CreatePlaylistConfirm.Visible=S.CreatePlaylistNameBox.Visible
        if S.CreatePlaylistNameBox.Visible then
    ...
    S.PlaylistSettingsTabBtn.MouseButton1Click:Connect(function()
        ...
        if S.SearchTabsScroll then S.SearchTabsScroll.CanvasPosition=Vector2.new(150,0) end
        refreshPlaylistDropdown()
    end)
