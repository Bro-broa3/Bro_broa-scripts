...
S = {
    ...
    soundEffectPresets={
        ...
        {name="Bass Boost", speed=1, bass=1.5, treble=1, reverb=0, echo=0},
        {name="Treble Boost", speed=1, bass=1, treble=1.5, reverb=0, echo=0},
        {name="Vocal", speed=1, bass=0.9, treble=1.3, reverb=0, echo=0},
        {name="Radio", speed=1, bass=0.8, treble=1.2, reverb=0, echo=0}
...
local function updateExtraMiniToggle() if not S.ExtraMiniToggle then return end; S.isKeyCorrect = S.isKeyCorrect == true; if not S.isKeyCorrect then S.ExtraMiniToggle.BackgroundColor3=Color3.fromRGB(180,80,80); S.ExtraMiniToggle.Text="LOCKED"; return end; S.ExtraMiniToggle.BackgroundColor3=S.extraMiniPlayMode and Color3.fromRGB(80,180,80) or Color3.fromRGB(180,80,80); S.ExtraMiniToggle.Text=S.extraMiniPlayMode and "ON" or "OFF" end
